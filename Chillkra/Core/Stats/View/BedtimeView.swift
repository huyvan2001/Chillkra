...
struct BedtimeView: View {
    ...
    var body: some View {
        ...
        VStack {
            TotalRow(title: "Total slept",
                     amount: "246",
                     nameAmount: "hours",
                     timeupdate: "Last update this morning")
            VStack{
                
                Text("Today sleep value")
                    .modifier(Fonts(fontName: .JosefinBold,
                ...
                HStack{
                    circle(percent: "\(Int(sleep.sleep/24*100))%",
                           colorstroke: "Search.lightBlue",
                           value: sleep.sleep, text: "Sleep")
                        .padding()
                    circle(percent: "\(Int(sleep.deep/24*100))%",
                           colorstroke: "Search.lightPurple",
                           value: sleep.sleep, text: "Deep")
                    circle(percent: "\(Int(sleep.quantity*100))%",
                           colorstroke: "Search.blue",
                           value: sleep.sleep, text: "Quantity")
                        .padding()
                }
